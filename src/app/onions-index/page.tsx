  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-8">
        <Link
          href="/"
          className="inline-flex items-center space-x-2 text-slate-500 hover:text-brand transition-colors">
      ...
      <header className="max-w-3xl mx-auto px-6 pt-12 pb-8">
        <p className="text-brand font-mono text-sm mb-4">Project Writeup</p>
        ...
        <div className="flex flex-wrap gap-4 mt-6">
          <a
            ...
            className="inline-flex items-center space-x-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-900 px-4 py-2 rounded-lg transition-colors text-sm font-mono">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="rounded-lg overflow-hidden border border-slate-200">
          <div className="bg-slate-100 px-4 py-2 flex items-center space-x-2">
            <span className="text-sm text-slate-500 font-mono">predict.py</span>
          </div>
    ...
    return champion_counts`}
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 space-y-8">
        ...
        <ul className="space-y-3 text-slate-700 text-lg leading-relaxed">
          <li>
            <strong className="text-slate-900">Champion:</strong> Duke (1) over
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={t.team} className="flex items-center gap-3">
              <span className="text-sm font-mono text-slate-700 w-28 shrink-0">
                {t.team}
              </span>
              <div className="flex-1 bg-slate-200 rounded-full h-5 overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-brand to-brand-dark rounded-full flex items-center justify-end pr-2"
